import bigdata.hermesfuxi.datayi.functions.{CombineUnique, CombineUnique2}
import org.apache.spark.sql.SparkSession

object CubeDistinctAggregationTest {
...
//    spark.udf.register("combine_unique", udaf(new CombineUnique(newStringArrayEncoder)));
    spark.udf.register("combine_unique", udaf(CombineUnique2));
